    ...
    #include "aicommands.def"
                ...
                case AI_PlayAnimation:
                {
                    ...
                    else if (AircraftEntityp)
                    {
                        ...
                        modelSetAnimation(AircraftEntityp->model, (ModelAnimation *)ANIM_TABLE_EXPANDED_PTR(animation_table_ptrs2[anim_id]), zero, startframe, 0.5f, (s32)ai->INTERPOL_TIME60);
                        if (endframe >= 0)
                        {
                ...
                case AI_MoveObject: // canonicly aiMoveObj
                {
                    ...
                    if (obj && obj->prop)
                    {
                        ...
                        {
                            coord3d padpos = pad->pos;
                            sub_GAME_7F04088C(obj, &padpos, &matrix, pad->stan, &padpos);
                        }
